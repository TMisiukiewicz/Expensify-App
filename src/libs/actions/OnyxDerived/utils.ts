...
/**
 * Flush all batched derived value updates to Onyx immediately
 */
...
/**
 * Set a derived value in Onyx with synchronous batching optimization
 * Collects multiple updates and flushes them together using setTimeout(0)
 * This ensures synchronous dependency updates are batched while avoiding microtask delays
 * Deduplicates updates to the same key, keeping only the latest value
